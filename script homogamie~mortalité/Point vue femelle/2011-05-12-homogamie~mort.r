...
sex_ratio <- seq(0.1,0.9,0.1) #sexe-ratio = nb males/taille pop totale
...
for (sr in sex_ratio){
	...
	windows()
	plot(pearson_sr~sex_ratio, type="l", ylim=c(0,1), xlim=c(0,1), ylab="Coefficient de Pearson", xlab="Sexe-ratio", 
			main="Valeurs d'homogamie à t = 1000 en fonction de la sexe-ratio",
