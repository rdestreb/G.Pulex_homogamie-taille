...
# }
	...
	plot(pearson_tp~taille_pop_totale, type ="l", ylim=c(0,1), xlim=c(min(taille_pop_totale),max(taille_pop_totale)), ylab="Coefficient de Pearson", xlab="Taille de la population", 
			main="Valeurs d'homogamie à t = 1000 en fonction de la taille de la population",
			sub=paste("tx_mortalité = ",tx_mort," ; tx_croissance = ",tx_croissance," ; sex-ratio = ",sex_ratio," ; réplicats = ",repetition ))
