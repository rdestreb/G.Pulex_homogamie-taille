...
# write.table(homogamie_sr, file = "script2011-05-23-mal-sr2-choixrandom.csv")
datafull <- read.table("data_script16.csv")
...
plot(pearson_sr ~ sex_ratio, data = datafull,
		...
		main = "Point vue mâle - choix random",
		sub = "n = 1000 ; ;TxM = 0.012 ; TxC = 1.1")
