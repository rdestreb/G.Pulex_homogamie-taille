...
sex_ratio <- seq(0.1,0.9,0.1) #sex-ratio = nb males/taille pop totale
...
for (sr_boucle in sex_ratio){
	...
	windows()
	plot(pearson_sr~sex_ratio, type="l", ylim=c(0,1), xlim=c(0,1), ylab="Coefficient de Pearson", xlab="Sex-ratio", 
			main="Valeurs d'homogamie à t = 1000 en fonction de la sex-ratio",
